...
if submitted:
    ...
    st.markdown("⚠️ NOTE: Make sure to review the output from ChatGPT before sending your email! LLMs have a mind of their own at times.")
    st.markdown("*Created by Graydon Whalley*")
